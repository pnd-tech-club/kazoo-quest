...
while stop != 1:
	if "started" not in triggers:
		print color['cyan'] + "Hello!  Welcome to Kazoo Quest!  This tutorial will run you through the mechanic of the game.  You should note that this entire game is text based and still in development- so be sure to not have too high of expectations.  You can type \"skip\" at any point to skip this tutorial." + color['off']
